...
<header class="text-gray-600 body-font px-24">
    <div class="container mx-auto flex flex-wrap py-5 flex-col md:flex-row items-center">
        ...
        <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
            <a href="{{route('course-oultines.index')}}" class="mr-5 hover:text-gray-900">Course Outline</a>
            <a class="mr-5 hover:text-gray-900">Assignment</a>
            <a class="mr-5 hover:text-gray-900">Score</a>
            <a class="mr-5 hover:text-gray-900">News</a>
        </nav>
        <div>Student Panel | {{Auth::user()->name}}</div>
